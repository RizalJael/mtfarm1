        ...
        <div class="container mx-auto w-full" style="max-width: 1000px;">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-3 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Data Ternak</h2>
                    ...
                    <div class="overflow-y-auto" style="max-height: 70vh;">
                        <table class="w-full whitespace-nowrap text-sm">
                            ...
                            <tbody class="bg-white">
                                @foreach ($ternaks as $index => $ternak)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-center space-x-2">
                                                <a href="{{ route('ternak.edit', $ternak->id) }}"
                                                ...
                                                <form action="{{ route('ternak.destroy', $ternak->id) }}"
