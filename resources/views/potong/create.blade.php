...
<head>
    ...
    <title>Tambah Data Potong</title>
</head>
        ...
        <div class="container mx-auto w-full" style="max-width: 700px;">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-3 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Data Potong</h2>
                ...
                <div class="p-6">
                    <form id="potongForm" action="{{ route('potong.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <select name="kode" id="kode"
                                    ...
                                    @foreach ($ternaks as $ternak)
                                        <option value="{{ $ternak->kode }}">{{ $ternak->kode }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-4">
