...
<head>
    ...
    <title>Tambah Data Mortal</title>
</head>
        ...
        <div class="container mx-auto w-full" style="max-width: 700px;">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-3 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Data Mortal</h2>
                ...
                <div class="p-6">
                    <form id="mortalForm" action="{{ route('mortal.store') }}" method="POST">
                        @csrf
