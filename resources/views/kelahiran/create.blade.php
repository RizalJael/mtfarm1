...
<head>
    ...
    <title>Tambah Data Ternak Kelahiran</title>
</head>
        ...
        <div class="container mx-auto w-full" style="max-width: 700px;">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-3 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Data Ternak Kelahiran</h2>
                ...
                <div class="p-6">
                    <form id="kelahiranForm" action="{{ route('kelahiran.store') }}" method="POST">
                        @csrf
