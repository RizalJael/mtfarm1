...
<head>
    ...
    <title>Edit Data Ternak Suplier</title>
</head>
        ...
        <div class="container mx-auto w-full" style="max-width: 700px;">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="flex justify-between items-center p-3 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Edit Data Ternak Suplier</h2>
                ...
                <div class="p-6">
                    <form id="suplierForm" action="{{ route('suplier.update', $ternak->id) }}" method="POST">
                        @csrf
                        @method('PUT')
